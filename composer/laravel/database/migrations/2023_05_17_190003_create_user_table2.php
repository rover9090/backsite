...
return new class extends Migration
{
    ...
    public function up(): void
    {
    	...
    	Schema::create('client_user_data2', function (Blueprint $table) {
            ...
            // //類型
             $table->integer('nType')->default(0);
            // //性別
             $table->tinyInteger('nSex')->default(0);
            // //身高
             $table->decimal('nHeight')->default(0);
            // //體重
             $table->decimal('nWeight')->default(0);
            // //興趣
             $table->string('sInterest', 100)->default('');
            // //介紹
             $table->string('sIntroduce', 500)->default('');
            // //圖片
