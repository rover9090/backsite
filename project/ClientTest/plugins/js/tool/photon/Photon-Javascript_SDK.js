    ...
    var PhotonPeer = /** @class */ (function () {
        ...
        */
        PhotonPeer.prototype.connect = function (appid) {
            ...
            var url = this.url + "/?libversion=4.1.0.0";
            if (this.subprotocol == "") {
        ...
        */
        ...
        PhotonPeer.prototype._onConnectFailed = function (evt) {
            //alert('PhotonPeer[_onConnectFailed] - Socket connection could not be created:', this.url, this.subprotocol, 'Wrong host or port?\n Raising "connectFailed event ...');
        ...
        PhotonPeer.prototype._onError = function (ev) {
            //alert("PhotonPeer[_onError] - Connection error:", arguments);
