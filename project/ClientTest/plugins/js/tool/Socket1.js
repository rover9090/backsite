...
$(document).ready(function()
{
	...
	var sUrl = 'wss://213.139.235.77:8091';
	// var sUrl = 'wss://demo801.dtap000s3.com:8091/Project/t_linegame06/EndTest/Bot/SocketServerhs.php';
					...
					case 'sticker':
						...
						(function(nUse){
							$('.JqStickerVideo').queue(function(){
								// console.log(gaUser['aData']['sName0']);
