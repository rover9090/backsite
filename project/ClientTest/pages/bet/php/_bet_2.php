<?php
	...
	$aUrl = array(
		...
		'sBet'		=> sys_web_encode($aMenuToNo['pages/bet/php/_bet_2.php']),
		'sIndex'		=> sys_web_encode($aMenuToNo['pages/index/php/_index_0.php']),
		'sHtml'	=> 'pages/bet/'.$aSystem['sClientHtml'].$aSystem['nVer'].'/bet_2.php',
	);
	#url結束
	...
	// if($nGame == 2001 && isset($_COOKIE['gino']))
	// {
	// 	unset($aJs['6']);
