...
<form action="<?php echo $aUrl['sPage'];?>" method="POST" class="MarginBottom20">
	<div>
		...
		<div class="Block MarginBottom20" >
			<span class="InlineBlockTit"><?php echo aLOGIN['ACCOUNT'];?></span>
			<div class="Ipt">
				<input type="text" name="sAccount" placeholder="<?php echo aLOGIN['ACCOUNT'];?>" value="<?php echo $sAccount;?>">
			</div>
		</div>
		<div class="Block MarginBottom20" >
			<span class="InlineBlockTit"><?php echo aLOGIN['IP'];?></span>
			<div class="Ipt">
				<input type="text" name="sIp" placeholder="<?php echo aLOGIN['IP'];?>" value="<?php echo $IP;?>">
			</div>
		</div>
				...
				<tbody>
					...
					foreach ($aData as $LPnId => $LPaData)
					{
						...
						<tr>
						     ...
						     <td><?php echo $aStatus[$LPaData['nStatus']]['sTitle'];?></td>
