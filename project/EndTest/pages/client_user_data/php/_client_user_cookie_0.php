<?php
	...
	#給此頁運用的js，按先後順序排列陣列
	$aJs = array(
		'plugins/js/client_user_data/client_user_cookie.js',
	);
	#js結束
	...
	#給此頁使用的url
	$aUrl   = array(
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_user_data/php/_client_user_cookie_0.php']),
		'sAjax0'	=> sys_web_encode($aMenuToNo['pages/client_user_data/php/_client_user_cookie_0_ajax0.php']),
		'sHtml'	=> 'pages/client_user_data/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_user_cookie_0.php',
	);
	#url結束
