...
<form action="<?php echo $aUrl['sPage']; ?>" method="POST" class="Form">
	<div class="Search">
		...
		<div class="Block MarginBottom20" >
			<span class="InlineBlockTit"><?php echo aUSER['HIDE1'];?></span>
			<div class="Sel">
				<select name="nHide">
					<?php
					foreach ($aHide as $LPnHide => $LPaHide)
					{
						?>
						<option value="<?php echo $LPnHide;?>" <?php echo $LPaHide['sSelect'];?> ><?php echo $LPaHide['sTitle'];?></option>
						<?php
					}
					?>
				</select>
			...
			<table>
				<thead>
					<tr>
						...
						<th><?php echo aUSER['HIDE1'];?></th>
						<th><?php echo aUSER['MONEY'];?></th>
						<th><?php echo aUSER['WATER'];?></th>
				...
				<tbody>
					...
					foreach ($aData as $LPnId => $LPaData)
					{
						...
						<tr>
							...
							<td class=""><?php echo $aPaData[$LPaData['nPa']]['sName'];?></td>
							<td class=""><?php echo $LPaData['sName1'];?></td>
							...
							<td class="<?php echo $aHide[$LPaData['nHide']]['sClass'];?>"><?php echo $LPaData['sHide'];?></td>
