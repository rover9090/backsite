...
<form action="<?php echo $aUrl['sPage'];?>" method="POST" class="Form MarginBottom20">
	<div>
		<div class="Block MarginBottom20" >
			...
			<div class="Ipt">
				<input type="text" name="sPromoCode" value="<?php echo $sPromoCode;?>" placeholder="<?php echo aPROMO['PROMOCODE'];?>" >
			</div>
		</div>
		<div class="Block MarginBottom20" >
		...
		<div class="InformationTableBox">
			<table>
				<thead>
					<tr>
						<th><?php echo NO;?></th>
						<th><?php echo aPROMO['PROMOCODE'];?></th>
						<th><?php echo aPROMO['FS'];?></th>
						<th><?php echo aPROMO['USEDTIMES'];?></th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo $LPaDetail['sPromoCode'];?></td>
							<td><?php echo $LPaDetail['sWater'].'%';?></td>
							<td><?php echo $LPaDetail['nUsedTimes'];?></td>
