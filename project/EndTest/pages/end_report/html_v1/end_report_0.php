	...
	<div class="InformationScroll">
		<div class="InformationTableBox">
			<table>
				<thead>
					<tr>
						<th colspan="5"><?php echo aREPORT['MEMBERDATA'];?></th>
						<!-- <th colspan="2"><?php echo aREPORT['MONEY'];?></th> -->
						<th colspan="9"><?php echo aREPORT['MEMBERCOUNT'];?></th>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?php echo round($LPaData['nAgentFs'],3);?></td>
							<td><?php echo round($LPaData['nBetFs'],3);?></td>
