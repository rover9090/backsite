<?php
	...
	#給此頁使用的url
	$aUrl   = array(
		'sPage'	=> sys_web_encode($aMenuToNo['pages/end_report/php/_end_report_donate_1.php']),
		'sUpt'	=> sys_web_encode($aMenuToNo['pages/end_report/php/_end_report_donate_1_upt0.php']),
		'sHtml'	=> 'pages/end_report/'.$aSystem['sHtml'].$aSystem['nVer'].'/end_report_donate_1.php',
	);
	#url結束
