...
<form action="<?php echo $aUrl['sAct'];?>" method="post" data-form="0">
	...
	?>
			<div class="Block MarginBottom20 DisplayBlockNone <?php echo $sActive;?>" data-show="<?php echo $LPsLang;?>">
				<span class="InlineBlockTit"><?php echo '桌名';?></span>
				<div class="Ipt">
	...
	?>
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo '排序';?></span>
		<div class="Ipt">
			<input type="text" name="nSort" value="<?php echo $aData[$aSystem['sLang']]['nSort'];?>">
		</div>
	</div>
