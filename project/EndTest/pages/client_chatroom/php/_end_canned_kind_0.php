<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_chatroom/php/_end_canned_kind_0_upt0.php']),
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_chatroom/php/_end_canned_kind_0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_chatroom/php/_end_canned_kind_0_act0.php']).'&run_page=1',
		'sHtml'	=> 'pages/client_chatroom/'.$aSystem['sHtml'].$aSystem['nVer'].'/end_canned_kind_0.php',
	);
	#url結束
