<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_withdrawal_list_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_withdrawal_list_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_withdrawal_list_0.php']),
		'sHtml'	=> 'pages/client_news/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_withdrawal_list_0.php',
	);
	#url結束
	...
	$sSQL = '	SELECT	nId,
					...
					sCreateTime,
					sUpdateTime
			FROM		'. CLIENT_WITHDRAWAL_LIST .' List_
			WHERE		nOnline != 99
					' . $sCondition . '
