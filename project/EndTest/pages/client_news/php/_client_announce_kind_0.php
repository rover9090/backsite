<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_announce_kind_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_announce_kind_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_announce_kind_0.php']),
		'sHtml'	=> 'pages/client_news/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_announce_kind_0.php'
	);
	#url結束
