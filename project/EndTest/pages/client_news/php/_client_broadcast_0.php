<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_broadcast_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_broadcast_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_news/php/_client_broadcast_0.php']),
		'sHtml'	=> 'pages/client_news/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_broadcast_0.php',
	);
	#url結束
	...
	{
		$aBroadCastKind[$aRows['nLid']] = $aRows;
		$aBroadCastKind[$aRows['nLid']]['sSelect'] = '';
		if($nKid == $aRows['nLid'])
		{
			$aBroadCastKind[$aRows['nLid']]['sSelect'] = 'selected';
		}
	}
	...
	while($aRows = $Result->fetch(PDO::FETCH_ASSOC))
	{
		...
		$aData[$aRows['nLid']]['sKind'] = $aBroadCastKind[$aRows['nKid']]['sName0'];
