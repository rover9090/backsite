...
<form action="<?php echo $aUrl['sPage'];?>" method="POST" class="Form MarginBottom20">
	<div>
		<div class="Block MarginBottom20" >
			...
			<div class="Ipt">
				<input type="text" name="sSearch" value="<?php echo $sSearch;?>" placeholder="<?php echo aBROADCAST['NAME'];?>">
			</div>
		</div>
		<div class="Block MarginBottom20" >
			...
			<div class="Sel">
				<select name="nKid">
					...
					<?php
						foreach ($aBroadCastKind as $LPnLid => $LPaDetail)
						{
					?>
		...
		<div class="InformationTableBox">
			<table>
				<thead>
					<tr>
						<th><?php echo NO;?></th>
						<th><?php echo aBROADCAST['NAME'];?></th>
						<th><?php echo aBROADCAST['KIND'];?></th>
