...
<form action="<?php echo $aUrl['sPage'];?>" method="POST" class="Form MarginBottom20">
	<div>
		<div class="Ipt">
			<input type="text" name="sSearch" value="<?php echo $sSearch;?>" placeholder="<?php echo aWITHDRAWALLIST['ACCOUNT'];?>">
		</div>
		<div class="Sel">
			<select name="nOnline">
	...
	<div class="InformationScroll">
		<div class="InformationTableBox">
			<table>
				<thead>
					<tr>
						<th><?php echo aWITHDRAWALLIST['ACCOUNT'];?></th>
						<th><?php echo aWITHDRAWALLIST['MONEY'];?></th>
