...
<form action="<?php echo $aUrl['sAct'];?>" method="post" data-form="0">
	...
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALLIST['ACCOUNT'];?></span>
		<div class="Ipt">
			<input type="text" name="sName0" value="<?php echo $aData['sName0'];?>" maxlength="20" minlength="10" required>
		</div>
	</div>

	<div class="Block">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALLIST['MONEY'];?></span>
		<div class="Ipt">
			<input type="number" name="nMoney" value="<?php echo $aData['nMoney'];?>" required>
		</div>
	</div>
