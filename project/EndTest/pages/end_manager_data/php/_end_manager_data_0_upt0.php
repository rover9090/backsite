<?php
	...
	#給此頁使用的url
	$aUrl   = array(
		'sBack'	=> sys_web_encode($aMenuToNo['pages/end_manager_data/php/_end_manager_data_0.php']),
	...
	$aOnline = array(
		'0' => array(
			'sTitle' => aMANAGER['OFFLINE'],
			'sSelect'=> '',
		),
		'1' => array(
			'sTitle' => aMANAGER['ONLINE'],
			'sSelect'=> '',
		),
	);
	$aValue = array(
	...
	{
		$aData['aControl'][$aRow['nMkid']][$aRow['nMlid']] = true;
	}
