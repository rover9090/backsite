...
<form action="<?php echo $aUrl['sAct'];?>" method="post" data-form="0">
	...
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aPAYMENTONLINESETTING['WITHDRAWAL'];?></span>
		<div class="Sel">
			<select name="nWithdrawal">
				<?php
					foreach($aWithdrawal as $LPnStatus => $LPaDetail)
					{
				?>
						<option value="<?php echo $LPnStatus;?>" <?php echo $LPaDetail['sSelect'];?>><?php echo $LPaDetail['sText'];?></option>
				<?php
	...
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aPAYMENTONLINESETTING['MEMO'];?></span>
		<div class="Ipt">
			<input type="text" name="sMemo" value="<?php echo $aData['sMemo'];?>">
		</div>
	</div>
