		...
		<div class="InformationTableBox">
			<table>
				<thead>
					<tr>
						<th><?php echo NO;?></th>
						<th><?php echo aPAYMENTONLINESETTING['NAME'];?></th>
						<th><?php echo aPAYMENTONLINESETTING['FEE'];?></th>
						<th><?php echo aPAYMENTONLINESETTING['MAX'];?></th>
						<th><?php echo aPAYMENTONLINESETTING['MIN'];?></th>
						<th><?php echo aPAYMENTONLINESETTING['DAYLIMITMONEY'];?></th>
						<th><?php echo aPAYMENTONLINESETTING['DAYLIMITTIMES'];?></th>
