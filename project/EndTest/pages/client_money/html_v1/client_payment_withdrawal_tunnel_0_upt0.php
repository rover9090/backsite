...
<form action="<?php echo $aUrl['sAct'];?>" method="post" data-form="0">
	...
	<!-- Select -->
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALTUNNEL['PAYMENT'];?></span>
		<div class="Sel">
			<select name="nPid">
				<?php
	...
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALTUNNEL['TUNNELKEY'];?></span>
		<div class="Ipt">
			<input type="text" name="sKey" value="<?php echo $aData['sKey'];?>">
		</div>
	</div>
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALTUNNEL['TUNNELVALUE'];?></span>
		<div class="Ipt">
			<input type="text" name="sValue" value="<?php echo $aData['sValue'];?>">
		</div>
	</div>
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALTUNNEL['TUNNELMIN'];?></span>
		<div class="Ipt">
			<input type="number" name="nMin" value="<?php echo number_format($aData['nMin'],0,'.','');?>">
		</div>
	</div>
	<div class="Block MarginBottom20">
		<span class="InlineBlockTit"><?php echo aWITHDRAWALTUNNEL['TUNNELMAX'];?></span>
		<div class="Ipt">
