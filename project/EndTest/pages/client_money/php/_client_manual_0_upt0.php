<?php
	...
	$aUrl = array(
		...
		'sBack'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_manual_0.php']),
	...
	$sSQL = '	SELECT	User_.nId,
			...
			AND		User_.sAccount LIKE :sName0
			AND		User_.nId = Money_.nUid
			LIMIT		1';
	$Result = $oPdo->prepare($sSQL);
	$Result->bindValue(':sName0', $sAccount, PDO::PARAM_STR);
	sql_query($Result);
