<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sIns'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_payment_company_setting_0_upt0.php']),
		'sDel'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_payment_company_setting_0_act0.php']).'&run_page=1',
		'sPage'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_payment_company_setting_0.php']),
		'sHtml'	=> 'pages/client_money/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_payment_company_setting_0.php',
	);
	#url結束
