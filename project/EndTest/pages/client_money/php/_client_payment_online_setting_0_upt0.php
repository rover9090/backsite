<?php
	...
	#給此頁使用的url
	$aUrl = array(
		'sAct'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_payment_online_setting_0_act0.php']).'&run_page=1',
		'sBack'	=> sys_web_encode($aMenuToNo['pages/client_money/php/_client_payment_online_setting_0.php']),
		'sHtml'	=> 'pages/client_money/'.$aSystem['sHtml'].$aSystem['nVer'].'/client_payment_online_setting_0_upt0.php',
	);
	#url結束
	...
	$aOnline = aONLINE;
	$aWithdrawal = aONLINE;
	$aFeeType = aPAYMENTONLINESETTING['FEETYPE'];
	#宣告結束
	...
	if($nId != 0)
	{
		...
		$aWithdrawal[$aData['nWithdrawal']]['sSelect'] = 'selected';
		$aData['aFeeType'][$aData['nType1']]['sCheck'] = 'checked';
	}
	else
	{
		$aData['sName0'] = '';
