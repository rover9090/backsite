$(document).ready(function()
{
	...
	// 手機選單-顯示
	$('.JqHeaderCtrlBtn').on('click',function()
	{
		$('.JqHeaderCtrlBox').addClass('active');
	});

	// 手機選單-關閉
	$('.JqHeaderCtrlBtnClose , .JqHeaderCtrlBg').on('click',function()
	{
		$('.JqHeaderCtrlBox').removeClass('active');
	});
	...
	// 切換語系
	$('#JqLang').on('change', function ()
	{
		var Url = window.location.href;
		console.log(Url);

		location.replace(Url+'&sLang='+$(this).val());
	});
